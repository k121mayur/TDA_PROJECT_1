### 1. Data Scrapping : I used python and normal requests library to scrap data and followed GitHub API documentation in this scrapping can't be paused or overwrite if restarted. 
